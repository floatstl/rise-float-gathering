        ...
        <section className="hero home about-page">
          ...
          <div className="hero-body">
            <div className="container">
              <div className="has-text-centered" ><img src={FloatLogo} alt="Float STL Logo"/></div><br/><br/>
              ...
              <br/><br/><br/><div className="title is-1 has-text-centered"><span className="icon"><a href="https://www.facebook.com/events/1901297480100411/" target="_blank"><i className="fa fa-facebook" style={{'color': 'white'}} aria-hidden="true"></i></a></span></div>
            </div>
          </div>
        </section>
